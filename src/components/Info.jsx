      ...
      <div className="container mx-auto max-w-screen-xl px-4">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
          ...
          <div className="lg:col-span-5 text-black" data-aos="fade-right ">
            {/* <p className="text-lg font-medium mb-2">Join us Now</p> */}
            ...
            {/* <h3 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-8 border-b border-black pb-4">
          ...
          <div className="lg:col-span-7" data-aos="fade-left">
            <div data-aos="fade-down" className=" relative">
              ...
              <form
                ...
                className="grid grid-cols-2 gap-6 bg-white p-6 rounded-xl shadow-lg relative z-50 floating w-full"
              >
                <div className="col-span-2 sm:col-span-1">
                  ...
                  <input
                    ...
                    id="Fname"
                    className="w-full px-4 py-3 border rounded-lg outline-none focus:border-orange-500"
